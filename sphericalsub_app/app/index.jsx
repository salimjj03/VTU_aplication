...
function App() {
    ...
    const { isLogIn, isLoading, setInfo } = useContext(GlobalContext);
    const [loading, setLoading] = useState(false)
    useEffect(() => {
            setLoading(true);
            axios.get(`${config.API_URL}/contact_info`)
            .then( (res) => {
    ...
    if ((Platform.OS === "web") && isLogIn && !isLoading) return <Redirect href="signin"/>
    if ((Platform.OS !== "web") && isLogIn && !isLoading) return <Redirect href="confirmLogin"/>
