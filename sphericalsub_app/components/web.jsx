...
import { Linking, View, Text, ScrollView, StyleSheet, TouchableOpacity, Dimensions, ImageBackground, Image } from "react-native";
    ...
    <View style={styles.container}>
      <View style={styles.header} className="bg-whdite">
          ...
          <Image
            ...
            />
            <Text style={styles.headerText}>{info?.site_name}</Text>
          </View>
      </View>
          ...
          <View className="gap-4">
              ...
              <Text className="text-grady font-pregular">
                ...
                <View className="gap-3">
                   ...
                   <TouchableOpacity
                    onPress = {  () => {
                        const url = 'https://expo.dev/artifacts/eas/ejK9AyRPXSYHgxjJemUzcG.apk'; // Replace with your desired URL
                            Linking.openURL(url)
...
const styles = StyleSheet.create({
  ...
  featuresGridMobile: { flexDirection: "column", alignItems: "center", width: "98%" },
