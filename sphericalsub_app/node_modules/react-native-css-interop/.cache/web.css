...
.border-primary {
  --tw-border-opacity: 1;
  border-color: rgb(70 130 180 / var(--tw-border-opacity, 1));
}

.border-primary-100 {
  --tw-border-opacity: 1;
  border-color: rgb(223 229 250 / var(--tw-border-opacity, 1));
}
...
.bg-primary-100 {
  --tw-bg-opacity: 1;
  background-color: rgb(223 229 250 / var(--tw-bg-opacity, 1));
}
...
.text-black-100 {
  --tw-text-opacity: 1;
  color: rgb(30 30 45 / var(--tw-text-opacity, 1));
}
...
.text-primary {
  --tw-text-opacity: 1;
  color: rgb(70 130 180 / var(--tw-text-opacity, 1));
}
...
.shadow-primary {
  --tw-shadow-color: #4682B4;
  --tw-shadow: var(--tw-shadow-colored);
}

.shadow-primary-100 {
  --tw-shadow-color: #DFE5FA;
  --tw-shadow: var(--tw-shadow-colored);
}
